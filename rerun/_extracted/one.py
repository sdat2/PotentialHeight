...
try:
    point_timeseries(member="r1i1p1f3",model="HadGEM3-GC31-MM",recalculate_pi=True,exp="historical",place="hong_kong",pressure_assumption="isothermal",pi_version=4)
    print("OK regenerated HK HadGEM3 r1 historical")
except Exception as e:
    import traceback; print("FAIL:",type(e).__name__,e); traceback.print_exc(limit=3)
print("DONE")
