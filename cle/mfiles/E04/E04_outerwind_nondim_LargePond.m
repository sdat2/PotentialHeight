...
function [rr,VV,r0,rrfracr0,MMfracM0] = E04_outerwind_nondim_LargePond(ruser,Vuser,fcor,Cdvary,C_d,w_cool,Nr)
...
[rrfracr0_temp,MMfracM0_temp] = E04_outerwind_r0input_nondim_MM0_LargePond(r0,fcor,Cdvary,C_d,w_cool,Nr);
M0 = .5*fcor*r0^2;
MuserM0 = Muser/M0;
ruserr0 = ruser/r0;
