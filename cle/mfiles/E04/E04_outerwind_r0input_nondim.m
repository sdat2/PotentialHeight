%E04_outerwind_r0input_nondim.m -- Emanuel (2004) model calculation
% Purpose: Emanuel (2004) non-convecting outer wind profile, given r0
%
% Syntax: [rr,VV,rrfracr0,MMfracM0] = E04_outerwind_r0input_nondim(r0,fcor,Cdvary,C_d,w_cool,Nr);
%
%
%Inputs:
...
function [rr,VV,rrfracr0,MMfracM0] = E04_outerwind_r0input_nondim(r0,fcor,Cdvary,C_d,w_cool,Nr)
