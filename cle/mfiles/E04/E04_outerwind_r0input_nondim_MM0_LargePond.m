...
function [rrfracr0,MMfracM0] = E04_outerwind_r0input_nondim_MM0_LargePond(r0,fcor,Cdvary,C_d,w_cool,Nr)
...
%%Large and Pond values (used in CAM5)
c4 = 0.0027;    %[m/s]
c5 = 0.000142;    %[-]
c6 = 0.0000764;    %[s/m]
V_temp_min = 0.85*0.5;  %[m/s]; 0.5 m/s = minimum wind speed in CAM5 at lowest model level (z>10m); 0.85 = reduction to z10 (Kevin Reed 2015-10-09)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%         end
        if(V_temp<=V_temp_min)
            V_temp = V_temp_min;
        end
        C_d = c4./V_temp + c5 + c6*V_temp;
