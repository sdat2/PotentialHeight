%ER11_radprof_raw_nondim_MMm.m -- ER11 profile, calculated non-dimensionally
%
% Syntax:  [rrfracrm,MMfracMm,rmax] = ER11_radprof_raw_nondim_MMm(Vmax,r_in,rmax_or_r0,fcor,CkCd)
%
% Inputs:
...
function [rrfracrm,MMfracMm,rmax] = ER11_radprof_raw_nondim_MMm(Vmax,r_in,rmax_or_r0,fcor,CkCd)
