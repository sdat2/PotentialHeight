...
def status_list(parent_dir: str, save_to: Optional[str] = None) -> List[bool]:
...
if __name__ == "__main__":
    ...
    parent_dir = (
        os.path.join(PROJ_PATH, args.runs_parent_name)
        if args.runs_parent_name is not None
        else os.path.join(PROJ_PATH, "runs")
    )
